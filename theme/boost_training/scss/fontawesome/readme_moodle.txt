...
2. SCSS. Replace the SCSS in this folder (/theme/boost_training/scss/fontawesome). Update theme/boost_training/thirdpartylibs.xml. Keep the moodle-paths.scss
